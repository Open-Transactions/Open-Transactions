...
public class Storage : global::System.IDisposable {
  ...
  public SWIGTYPE_p_OTPacker GetPacker(PackType ePackType) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_GetPacker__SWIG_0(swigCPtr, (int)ePackType);
  ...
  public virtual long FormPathString(SWIGTYPE_p_std__string strOutput, string strFolder, string oneStr, string twoStr, string threeStr) {
    long ret = otapiPINVOKE.Storage_FormPathString__SWIG_0(swigCPtr, SWIGTYPE_p_std__string.getCPtr(strOutput), strFolder, oneStr, twoStr, threeStr);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual long FormPathString(SWIGTYPE_p_std__string strOutput, string strFolder, string oneStr, string twoStr) {
    long ret = otapiPINVOKE.Storage_FormPathString__SWIG_1(swigCPtr, SWIGTYPE_p_std__string.getCPtr(strOutput), strFolder, oneStr, twoStr);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Storable QueryObject(StoredObjectType theObjectType, string strFolder, string oneStr, string twoStr, string threeStr) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_QueryObject__SWIG_0(swigCPtr, (int)theObjectType, strFolder, oneStr, twoStr, threeStr);
  ...
  public Storable QueryObject(StoredObjectType theObjectType, string strFolder, string oneStr, string twoStr) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_QueryObject__SWIG_1(swigCPtr, (int)theObjectType, strFolder, oneStr, twoStr);
    Storable ret = (cPtr == global::System.IntPtr.Zero) ? null : new Storable(cPtr, true);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Storable QueryObject(StoredObjectType theObjectType, string strFolder, string oneStr) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_QueryObject__SWIG_2(swigCPtr, (int)theObjectType, strFolder, oneStr);
    Storable ret = (cPtr == global::System.IntPtr.Zero) ? null : new Storable(cPtr, true);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Storable QueryObject(StoredObjectType theObjectType, string strFolder) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_QueryObject__SWIG_3(swigCPtr, (int)theObjectType, strFolder);
    Storable ret = (cPtr == global::System.IntPtr.Zero) ? null : new Storable(cPtr, true);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static Storage Create(StorageType eStorageType, PackType ePackType) {
    global::System.IntPtr cPtr = otapiPINVOKE.Storage_Create((int)eStorageType, (int)ePackType);
